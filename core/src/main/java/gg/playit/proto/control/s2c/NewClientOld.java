...
public record NewClientOld(SocketAddr connect_addr, SocketAddr peer_addr, ClaimInstructions claim_instructions, long tunnel_server_id, int data_center_id) implements WireReadable {
